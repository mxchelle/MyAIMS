...
#spotlightController = (resourceID) ->
...
Template.blogAdminEdit.onRendered ->
  ...
  # We cant use reactive template vars for contenteditable :-(
...
Template.blogAdminEdit.helpers
  spotightID: -> 
    ...
    if id is 'new' or id is 'null'
      return Template.instance().firstID
    else
      return id
  post: ->
